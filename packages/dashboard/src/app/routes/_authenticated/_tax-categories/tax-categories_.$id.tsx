...
function TaxCategoryDetailPage() {
    ...
    const { form, submitHandler, entity, isPending, resetForm } = useDetailPage({
        ...
        onSuccess: async data => {
            toast.success(creatingNewEntity ? i18n.t('Successfully created tax category') : i18n.t('Successfully updated tax category'));
        ...
        onError: err => {
            toast.error(creatingNewEntity ? i18n.t('Failed to create tax category') : i18n.t('Failed to update tax category'), {
