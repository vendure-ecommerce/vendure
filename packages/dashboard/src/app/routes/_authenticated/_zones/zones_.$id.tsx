...
function ZoneDetailPage() {
    ...
    const { form, submitHandler, entity, isPending, resetForm } = useDetailPage({
        ...
        onSuccess: async data => {
            toast.success(creatingNewEntity ? i18n.t('Successfully created zone') : i18n.t('Successfully updated zone'));
            resetForm();
        ...
        onError: err => {
            toast.error(creatingNewEntity ? i18n.t('Failed to create zone') : i18n.t('Failed to update zone'), {
