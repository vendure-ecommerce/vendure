...
/**
 * @description
 * Props for configuring the {@link DraggableDataTable}.
 *
 * @docsCategory list-views
 * @docsPage DraggableDataTable
 * @since 3.3.0
 */
...
/**
 * @description
 * A data table with drag-and-drop functionality for reordering items.
 * Extends the functionality of {@link DataTable} with drag-and-drop capabilities.
 *
 * @docsCategory list-views
 * @docsPage DraggableDataTable
 * @since 3.3.0
...
}: Readonly<DraggableDataTableProps<TData>>) {
                                ...
                                <TableBody>
                                    {isLoading && !localData?.length ? (
                                        ...
                                        <TableRow className="animate-in fade-in duration-100">
                                            <TableCell
                                                colSpan={
                                                    enhancedColumns.length + (!isDragDisabled ? 1 : 0)
                                                }
