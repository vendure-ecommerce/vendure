import {
    ...
    UpdatePendingFulfillmentMutation,
    UpdatePendingFulfillmentMutationVariables,
...
export class OrderDataService {
    ...
    updatePendingFulfillment(input: UpdatePendingFulfillmentInput) {
        return this.baseDataService.mutate<
            UpdatePendingFulfillmentMutation,
            UpdatePendingFulfillmentMutationVariables
        >(UPDATE_PENDING_FULFILLMENT, {
