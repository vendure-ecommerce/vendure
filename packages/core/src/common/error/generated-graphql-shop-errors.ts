...
export class VerificationPendingError extends ErrorResult {
  readonly __typename = 'VerificationPendingError';
  readonly errorCode = 'VERIFICATION_PENDING_ERROR' as any;
  readonly message = 'VERIFICATION_PENDING_ERROR';
  constructor(
