...
import { ADD_CUSTOMERS_TO_GROUP, GET_CUSTOMER_GROUP } from './customer-group.e2e-spec';
import { CREATE_ADDRESS, CREATE_CUSTOMER, DELETE_CUSTOMER, UPDATE_ADDRESS } from './customer.e2e-spec';
import {
    AddCustomersToGroup,
    CreateAddress,
    CreateChannel,
...
import { DELETE_ADDRESS, REGISTER_ACCOUNT, UPDATE_CUSTOMER } from './graphql/shop-definitions';
