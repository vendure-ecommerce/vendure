...
export type GetActiveCustomerOrderWithItemFulfillmentsQuery = { activeCustomer?: { orders: { totalItems: number, items: Array<{ id: string, code: string, state: string, lines: Array<{ id: string, items: Array<{ id: string, fulfillment?: { id: string, state: string, method: string, trackingCode?: string | null } | null }> }> }> } } | null };
