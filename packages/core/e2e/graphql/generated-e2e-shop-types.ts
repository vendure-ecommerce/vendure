...
export enum ErrorCode {
    ...
    VERIFICATION_PENDING_ERROR = 'VERIFICATION_PENDING_ERROR',
...
/**
 * Returned if `authOptions.requireVerification` is set to `true` (which is the default)
 * and an unverified user attempts to register as a new customer.
 */
export type VerificationPendingError = ErrorResult & {
    errorCode: ErrorCode;
    message: Scalars['String']['output'];
};
