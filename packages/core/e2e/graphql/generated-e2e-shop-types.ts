...
export type TestOrderFragmentFragment = (
  ...
  & { discounts: Array<Pick<Adjustment, 'adjustmentSource' | 'amount' | 'description' | 'type'>>, lines: Array<(
    Pick<OrderLine, 'id' | 'quantity' | 'linePrice' | 'linePriceWithTax' | 'unitPrice' | 'unitPriceWithTax' | 'unitPriceChangeSinceAdded' | 'unitPriceWithTaxChangeSinceAdded'>
    & { productVariant: Pick<ProductVariant, 'id'>, discounts: Array<Pick<Adjustment, 'adjustmentSource' | 'amount' | 'description' | 'type'>>, items: Array<Pick<OrderItem, 'id' | 'unitPrice' | 'unitPriceWithTax'>> }
...
export type UpdatedOrderFragment = (
  ...
  & { lines: Array<(
    ...
    & { productVariant: Pick<ProductVariant, 'id'>, discounts: Array<Pick<Adjustment, 'adjustmentSource' | 'amount' | 'description' | 'type'>> }
...
export type GetActiveOrderWithPriceDataQuery = { activeOrder?: Maybe<(
    ...
    & { lines: Array<(
      ...
      & { items: Array<Pick<OrderItem, 'id' | 'unitPrice' | 'unitPriceWithTax' | 'taxRate'>>, adjustments: Array<Pick<Adjustment, 'amount' | 'type'>>, taxLines: Array<Pick<TaxLine, 'taxRate' | 'description'>> }
...
export type GetShippingMethodsQuery = { eligibleShippingMethods: Array<Pick<ShippingMethodQuote, 'id' | 'price' | 'name' | 'description'>> };
...
export namespace GetActiveOrderWithPriceData {
  ...
  export type Adjustments = NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetActiveOrderWithPriceDataQuery['activeOrder']>)['lines']>)[number]>['adjustments']>)[number]>;
