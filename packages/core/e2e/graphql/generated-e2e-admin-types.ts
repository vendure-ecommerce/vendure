...
export type GetOrderFulfillmentsQuery = {
    order?: {
        id: string;
        state: string;
        fulfillments?: Array<{ id: string; state: string; nextStates: Array<string>; method: string }> | null;
    } | null;
};
...
export type CancelOrderMutation = {
    cancelOrder:
        ...
        | { errorCode: ErrorCode; message: string }
        | { errorCode: ErrorCode; message: string }
        | { id: string; lines: Array<{ quantity: number; items: Array<{ id: string; cancelled: boolean }> }> }
        | { errorCode: ErrorCode; message: string }
        | { errorCode: ErrorCode; message: string };
};
