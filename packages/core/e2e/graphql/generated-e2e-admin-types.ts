...
export type AuthenticateMutation = { authenticate: CurrentUserFragment | Pick<InvalidCredentialsError, 'errorCode' | 'message'> };
...
export namespace Authenticate {
  ...
  export type ErrorResultInlineFragment = (DiscriminateUnion<(NonNullable<AuthenticateMutation['authenticate']>), { __typename?: 'ErrorResult' }>);
}
