...
export type GetOrderFulfillmentsQuery = { order?: { id: string, state: string, fulfillments?: Array<{ id: string, state: string, nextStates: Array<string>, method: string }> | null } | null };
