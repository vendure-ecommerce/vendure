...
export type GetDuplicatedCollectionQueryVariables = Exact<{
  id?: InputMaybe<Scalars['ID']['input']>;
}>;


export type GetDuplicatedCollectionQuery = { collection?: { id: string, name: string, slug: string } | null };
