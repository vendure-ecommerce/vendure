...
export type GetGlobalSettingsQuery = { globalSettings: { id: string, availableLanguages: Array<LanguageCode>, trackInventory: boolean, outOfStockThreshold: number, serverConfig: { permittedAssetTypes: Array<string>, orderProcess: Array<{ name: string, to: Array<string> }>, permissions: Array<{ name: string, description: string, assignable: boolean }>, customFieldConfig: { Customer: Array<{ name: string } | { name: string } | { name: string } | { name: string } | { name: string } | { name: string } | { name: string } | { name: string }> } } } };
...
export type OrderItemFragment = { id: string, cancelled: boolean, unitPrice: number, unitPriceWithTax: number, taxRate: number, fulfillment?: { id: string } | null };
...
export type FulfillmentFragment = { id: string, state: string, nextStates: Array<string>, method: string, trackingCode?: string | null, orderItems: Array<{ id: string }> };
...
export type AttemptLoginMutation = { login: { id: string, identifier: string, channels: Array<{ code: string, token: string, permissions: Array<Permission> }> } | {} };
...
export type CreateFulfillmentMutation = { addFulfillmentToOrder: { errorCode: ErrorCode, message: string, fulfillmentHandlerError: string } | { errorCode: ErrorCode, message: string } | { id: string, state: string, nextStates: Array<string>, method: string, trackingCode?: string | null, orderItems: Array<{ id: string }> } | { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } };
...
export type TransitFulfillmentMutation = { transitionFulfillmentToState: { id: string, state: string, nextStates: Array<string>, method: string, trackingCode?: string | null, orderItems: Array<{ id: string }> } | { errorCode: ErrorCode, message: string, transitionError: string, fromState: string, toState: string } };
...
export type CancelOrderMutation = { cancelOrder: { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } | { id: string, state: string, lines: Array<{ quantity: number, items: Array<{ id: string, cancelled: boolean }> }> } | { errorCode: ErrorCode, message: string } | { errorCode: ErrorCode, message: string } };

export type CanceledOrderFragment = { id: string, state: string, lines: Array<{ quantity: number, items: Array<{ id: string, cancelled: boolean }> }> };
...
export type GetOrderFulfillmentItemsQuery = { order?: { id: string, state: string, fulfillments?: Array<{ id: string, state: string, nextStates: Array<string>, method: string, trackingCode?: string | null, orderItems: Array<{ id: string }> }> | null } | null };
...
export type GetOrderLineFulfillmentsQuery = { order?: { id: string, lines: Array<{ id: string, fulfillments?: Array<{ id: string, state: string, summary: Array<{ quantity: number, orderLine: { id: string } }> }> | null }> } | null };
...
export type RemoveMembersFromZoneMutation = { removeMembersFromZone: { id: string, name: string, members: Array<{ id: string, code: string, name: string, enabled: boolean, translations: Array<{ id: string, languageCode: LanguageCode, name: string }> }> } };
