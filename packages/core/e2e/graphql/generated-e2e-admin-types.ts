...
export type SetOrderCustomerMutation = { setOrderCustomer?: { id: string, customer?: { id: string } | null, history: { items: Array<{ id: string, type: HistoryEntryType, isPublic: boolean, data: any }> } } | null };
