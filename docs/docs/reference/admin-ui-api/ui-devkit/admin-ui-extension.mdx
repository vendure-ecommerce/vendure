...
<GenerationInfo sourceFile="packages/ui-devkit/src/compiler/types.ts" sourceLine="274" packageName="@vendure/ui-devkit" />
...
```
<GenerationInfo sourceFile="packages/ui-devkit/src/compiler/types.ts" sourceLine="283" packageName="@vendure/ui-devkit" />
...
<GenerationInfo sourceFile="packages/ui-devkit/src/compiler/types.ts" sourceLine="310" packageName="@vendure/ui-devkit" />
