...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/form-engine/form-engine-types.ts" sourceLine="165" packageName="@vendure/dashboard" since="3.4.0" />
