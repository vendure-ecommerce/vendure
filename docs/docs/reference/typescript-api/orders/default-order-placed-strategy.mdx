...
The default <DocsLink href="/reference/typescript-api/orders/order-placed-strategy#orderplacedstrategy">OrderPlacedStrategy</DocsLink>. The order is set as "placed" when it transitions from
...
```
* Implements: <DocsLink href="/reference/typescript-api/orders/order-placed-strategy#orderplacedstrategy">`OrderPlacedStrategy`</DocsLink>
