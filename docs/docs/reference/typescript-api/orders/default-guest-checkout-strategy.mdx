...
The default implementation of the [GuestCheckoutStrategy](/reference/typescript-api/orders/guest-checkout-strategy#guestcheckoutstrategy). This strategy allows
...
```
* Implements: [`GuestCheckoutStrategy`](/reference/typescript-api/orders/guest-checkout-strategy#guestcheckoutstrategy)
...
Options available for the [DefaultGuestCheckoutStrategy](/reference/typescript-api/orders/default-guest-checkout-strategy#defaultguestcheckoutstrategy).
