...
The default implementation of the <DocsLink href="/reference/typescript-api/orders/guest-checkout-strategy#guestcheckoutstrategy">GuestCheckoutStrategy</DocsLink>. This strategy allows
...
```
* Implements: <DocsLink href="/reference/typescript-api/orders/guest-checkout-strategy#guestcheckoutstrategy">`GuestCheckoutStrategy`</DocsLink>
...
Options available for the <DocsLink href="/reference/typescript-api/orders/default-guest-checkout-strategy#defaultguestcheckoutstrategy">DefaultGuestCheckoutStrategy</DocsLink>.
