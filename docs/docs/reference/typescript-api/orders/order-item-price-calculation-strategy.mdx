...
passed in to this method if they are set to `eager: true`. Otherwise, you can use the [EntityHydrator](/reference/typescript-api/data-access/entity-hydrator#entityhydrator)
