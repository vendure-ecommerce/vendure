...
The default [ActiveOrderStrategy](/reference/typescript-api/orders/active-order-strategy#activeorderstrategy), which uses the current [Session](/reference/typescript-api/entities/session#session) to determine
...
```
* Implements: [`ActiveOrderStrategy`](/reference/typescript-api/orders/active-order-strategy#activeorderstrategy)
