...
Returns true if the [ErrorResultUnion](/reference/typescript-api/errors/error-result-union#errorresultunion) is actually an ErrorResult type. This is useful when dealing with
