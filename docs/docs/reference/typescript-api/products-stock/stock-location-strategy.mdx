...
The StockLocationStrategy is responsible for determining which <DocsLink href="/reference/typescript-api/entities/stock-location#stocklocation">StockLocation</DocsLink>s
should be used to fulfill an <DocsLink href="/reference/typescript-api/entities/order-line#orderline">OrderLine</DocsLink> and how much stock should be allocated
from each location. It is also used to determine the available stock for a given
<DocsLink href="/reference/typescript-api/entities/product-variant#productvariant">ProductVariant</DocsLink>.
...
<DocsLink href="/reference/typescript-api/products-stock/stock-location-strategy#stocklocationstrategy">StockLocationStrategy</DocsLink>'s `getAvailableStock` method.
