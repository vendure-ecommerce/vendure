...
The MultiChannelStockLocationStrategy is an implementation of the <DocsLink href="/reference/typescript-api/products-stock/stock-location-strategy#stocklocationstrategy">StockLocationStrategy</DocsLink>.
...
does not take channels into account, update your VendureConfig to use to <DocsLink href="/reference/typescript-api/products-stock/default-stock-location-strategy#defaultstocklocationstrategy">DefaultStockLocationStrategy</DocsLink>.
