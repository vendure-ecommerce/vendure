...
The DefaultStockLocationStrategy was the default implementation of the <DocsLink href="/reference/typescript-api/products-stock/stock-location-strategy#stocklocationstrategy">StockLocationStrategy</DocsLink>
prior to the introduction of the <DocsLink href="/reference/typescript-api/products-stock/multi-channel-stock-location-strategy#multichannelstocklocationstrategy">MultiChannelStockLocationStrategy</DocsLink>.
