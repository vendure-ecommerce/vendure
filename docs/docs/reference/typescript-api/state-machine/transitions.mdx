...
on [FSM](/reference/typescript-api/state-machine/fsm#fsm).
...
transitions is being merged with another (as in the case of defining a [OrderProcess](/reference/typescript-api/orders/order-process#orderprocess))
