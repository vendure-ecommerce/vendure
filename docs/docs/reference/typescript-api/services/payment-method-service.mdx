...
Provides methods for managing [PaymentMethod](/reference/typescript-api/entities/payment-method#paymentmethod) entities, including eligibility checking and handler configuration.
