...
Contains methods relating to <DocsLink href="/reference/typescript-api/entities/asset#asset">Asset</DocsLink> entities.
...
Used when updating entities which implement <DocsLink href="/reference/typescript-api/services/asset-service#entitywithassets">EntityWithAssets</DocsLink>.
