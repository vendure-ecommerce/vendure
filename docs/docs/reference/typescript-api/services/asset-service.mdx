...
Certain entities ([Product](/reference/typescript-api/entities/product#product), [ProductVariant](/reference/typescript-api/entities/product-variant#productvariant), [Collection](/reference/typescript-api/entities/collection#collection)) use this interface
