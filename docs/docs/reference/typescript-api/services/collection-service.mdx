...
Provides methods for managing [Collection](/reference/typescript-api/entities/collection#collection) entities, including tree operations and filter-based product assignment.
