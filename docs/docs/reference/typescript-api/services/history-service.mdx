...
Contains methods relating to <DocsLink href="/reference/typescript-api/entities/history-entry#historyentry">HistoryEntry</DocsLink> entities. Histories are timelines of actions
