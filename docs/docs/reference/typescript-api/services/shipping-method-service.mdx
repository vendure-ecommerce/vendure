...
Provides methods for managing [ShippingMethod](/reference/typescript-api/entities/shipping-method#shippingmethod) entities, including eligibility checking and calculator configuration.
