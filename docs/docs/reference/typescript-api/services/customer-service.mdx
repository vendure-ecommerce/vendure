...
Provides methods for managing [Customer](/reference/typescript-api/entities/customer#customer) entities, including registration, address management and group assignment.
