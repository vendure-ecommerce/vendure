...
By default, the <DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-strategy#defaultschedulerstrategy">DefaultSchedulerStrategy</DocsLink> will use the database to enable
this functionality.
...
For instance, in the <DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-strategy#defaultschedulerstrategy">DefaultSchedulerStrategy</DocsLink> we make use of a
...
For instance, in the <DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-strategy#defaultschedulerstrategy">DefaultSchedulerStrategy</DocsLink> this is done by setting
