...
The options for the <DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-plugin#defaultschedulerplugin">DefaultSchedulerPlugin</DocsLink>.
