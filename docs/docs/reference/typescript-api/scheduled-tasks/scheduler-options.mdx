...
<DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-plugin#defaultschedulerplugin">DefaultSchedulerPlugin</DocsLink> (which is recommended) then this will be set to the
<DocsLink href="/reference/typescript-api/scheduled-tasks/default-scheduler-strategy#defaultschedulerstrategy">DefaultSchedulerStrategy</DocsLink>.
### tasks
