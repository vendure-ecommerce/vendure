...
A helper which contains methods for creating and updating entities which implement the <DocsLink href="/reference/typescript-api/entities/interfaces#translatable">Translatable</DocsLink> interface.
