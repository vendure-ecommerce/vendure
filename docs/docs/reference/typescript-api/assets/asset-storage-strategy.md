...
interface AssetStorageStrategy extends InjectableStrategy {
    ...
    writeFileFromStream(fileName: string, data: Stream, encoding?: string): Promise<string>;
    readFileToBuffer(identifier: string): Promise<Buffer>;
    readFileToStream(identifier: string, encoding?: string): Promise<Stream>;
...
<MemberInfo kind="method" type={`(fileName: string, data: Stream, encoding?: BufferEncoding) => Promise&#60;string&#62;`}   />
