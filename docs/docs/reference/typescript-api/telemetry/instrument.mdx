...
with an <DocsLink href="/reference/typescript-api/telemetry/instrumentation-strategy#instrumentationstrategy">InstrumentationStrategy</DocsLink> which defines how the instrumentation should be applied.
