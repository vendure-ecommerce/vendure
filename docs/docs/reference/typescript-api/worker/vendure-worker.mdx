...
This object is created by calling the <DocsLink href="/reference/typescript-api/worker/bootstrap-worker#bootstrapworker">bootstrapWorker</DocsLink> function.
