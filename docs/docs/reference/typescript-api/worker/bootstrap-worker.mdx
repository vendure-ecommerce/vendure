...
Bootstraps a Vendure worker. Resolves to a <DocsLink href="/reference/typescript-api/worker/vendure-worker#vendureworker">VendureWorker</DocsLink> object containing a reference to the underlying
...
See the `ignoreCompatibilityErrorsForPlugins` option in <DocsLink href="/reference/typescript-api/common/bootstrap#bootstrapoptions">BootstrapOptions</DocsLink>.
