...
Address based <DocsLink href="/reference/typescript-api/tax/tax-zone-strategy#taxzonestrategy">TaxZoneStrategy</DocsLink> which tries to find the applicable <DocsLink href="/reference/typescript-api/entities/zone#zone">Zone</DocsLink> based on the
...
Returns the default <DocsLink href="/reference/typescript-api/entities/channel#channel">Channel</DocsLink>'s default tax zone if no applicable zone is found.
...
```
* Implements: <DocsLink href="/reference/typescript-api/tax/tax-zone-strategy#taxzonestrategy">`TaxZoneStrategy`</DocsLink>
