...
<GenerationInfo sourceFile="packages/core/src/health-check/typeorm-health-check-strategy.ts" sourceLine="36" packageName="@bb-vendure/core" />
...
```ts
import { TypeORMHealthCheckStrategy } from '@bb-vendure/core';
