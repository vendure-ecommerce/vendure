...
This entity represents a fulfillment of an Order or part of it, i.e. which <DocsLink href="/reference/typescript-api/entities/order-line#orderline">OrderLine</DocsLink>s have been
