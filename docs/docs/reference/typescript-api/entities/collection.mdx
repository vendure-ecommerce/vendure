...
A Collection is a grouping of <DocsLink href="/reference/typescript-api/entities/product#product">Product</DocsLink>s based on various configurable criteria.
...
* Implements: <DocsLink href="/reference/typescript-api/entities/interfaces#translatable">`Translatable`</DocsLink>, HasCustomFields, <DocsLink href="/reference/typescript-api/entities/interfaces#channelaware">`ChannelAware`</DocsLink>, <DocsLink href="/reference/typescript-api/entities/interfaces#orderable">`Orderable`</DocsLink>
