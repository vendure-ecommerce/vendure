...
* Implements: <DocsLink href="/reference/typescript-api/entities/interfaces#taggable">`Taggable`</DocsLink>, <DocsLink href="/reference/typescript-api/entities/interfaces#channelaware">`ChannelAware`</DocsLink>, HasCustomFields
