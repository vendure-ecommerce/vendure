...
Each assigned [PromotionCondition](/reference/typescript-api/promotions/promotion-condition#promotioncondition) is checked against the Order, and if they all return `true`,
then each assign [PromotionItemAction](/reference/typescript-api/promotions/promotion-action#promotionitemaction) / [PromotionLineAction](/reference/typescript-api/promotions/promotion-action#promotionlineaction) / [PromotionOrderAction](/reference/typescript-api/promotions/promotion-action#promotionorderaction) / [PromotionShippingAction](/reference/typescript-api/promotions/promotion-action#promotionshippingaction) is applied to the Order.
...
* Implements: [`ChannelAware`](/reference/typescript-api/entities/interfaces#channelaware), [`SoftDeletable`](/reference/typescript-api/entities/interfaces#softdeletable), HasCustomFields, [`Translatable`](/reference/typescript-api/entities/interfaces#translatable)
