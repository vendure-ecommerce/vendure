...
This is an abstract class which is extended by the [Country](/reference/typescript-api/entities/country#country) and [Province](/reference/typescript-api/entities/province#province) entities.
Regions can be grouped into [Zone](/reference/typescript-api/entities/zone#zone)s which are in turn used to determine applicable shipping and taxes for an [Order](/reference/typescript-api/entities/order#order).
...
* Implements: [`Translatable`](/reference/typescript-api/entities/interfaces#translatable), HasCustomFields
