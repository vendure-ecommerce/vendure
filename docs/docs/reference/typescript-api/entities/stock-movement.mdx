...
(as configured by the [StockAllocationStrategy](/reference/typescript-api/orders/stock-allocation-strategy#stockallocationstrategy). This prevents stock being sold twice.
...
```
* Extends: [`StockMovement`](/reference/typescript-api/entities/stock-movement#stockmovement)
