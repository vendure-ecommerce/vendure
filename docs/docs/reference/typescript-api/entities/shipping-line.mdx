...
A ShippingLine is created when a [ShippingMethod](/reference/typescript-api/entities/shipping-method#shippingmethod) is applied to an [Order](/reference/typescript-api/entities/order#order).
