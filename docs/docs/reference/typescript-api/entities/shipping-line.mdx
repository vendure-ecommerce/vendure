...
A ShippingLine is created when a <DocsLink href="/reference/typescript-api/entities/shipping-method#shippingmethod">ShippingMethod</DocsLink> is applied to an <DocsLink href="/reference/typescript-api/entities/order#order">Order</DocsLink>.
