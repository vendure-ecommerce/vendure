...
A Seller represents the person or organization who is selling the goods on a given <DocsLink href="/reference/typescript-api/entities/channel#channel">Channel</DocsLink>.
...
* Implements: <DocsLink href="/reference/typescript-api/entities/interfaces#softdeletable">`SoftDeletable`</DocsLink>, HasCustomFields
