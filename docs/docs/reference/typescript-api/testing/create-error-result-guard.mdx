...
Convenience method for creating an <DocsLink href="/reference/typescript-api/testing/error-result-guard#errorresultguard">ErrorResultGuard</DocsLink>. Takes a predicate function which
