...
A <DocsLink href="/reference/typescript-api/configuration/vendure-config#vendureconfig">VendureConfig</DocsLink> object used for e2e tests. This configuration uses sqljs as the database
