...
options is used (see <DocsLink href="/reference/typescript-api/data-access/hydrate-options#hydrateoptions">HydrateOptions</DocsLink>), any related ProductVariant will have the correct
