...
property names to the entity's prototype. This array is then used by the [CalculatedPropertySubscriber](/reference/typescript-api/data-access/calculated-property-subscriber#calculatedpropertysubscriber)
