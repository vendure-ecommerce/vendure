...
Most entities can have additional fields added to them by defining an array of <DocsLink href="/reference/typescript-api/custom-fields/custom-field-config#customfieldconfig">CustomFieldConfig</DocsLink>objects on against the corresponding key.
