...
metaTitle: "Configuring Shipping Methods in Vendure"
metaDescription: "Define shipping eligibility checkers, calculators, and fulfillment handlers in Vendure. Test shipping methods against sample orders directly in the Admin UI."
---
