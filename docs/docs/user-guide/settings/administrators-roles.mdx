...
metaTitle: "Managing Administrators and Permission Roles in Vendure"
metaDescription: "Create administrator accounts, define roles with granular CRUD permissions, and compose multiple roles together to control staff access in the Vendure Admin UI."
---
