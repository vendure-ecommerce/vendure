---
title: "Products"
metaTitle: "Managing Products and Variants in Vendure"
metaDescription: "Understand the relationship between Products and ProductVariants, configure pricing and SKUs on variants, and track inventory with back-order support."
---
