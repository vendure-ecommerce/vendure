---
title: "Localization"
metaTitle: "Localization and Multi-Language Support in Vendure"
metaDescription: "Enable multiple languages for products, collections, facets, and other translatable objects. Switch the Admin UI language independently from storefront translations."
order: 10
---
