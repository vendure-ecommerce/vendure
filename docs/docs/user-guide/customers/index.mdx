...
metaDescription: "View, search, and edit customer records in the Vendure Admin UI. Understand guest, registered, and verified statuses, and organize customers into groups."
order: 2
---
