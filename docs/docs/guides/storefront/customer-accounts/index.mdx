...
metaTitle: "Customer Account Management in a Vendure Storefront"
metaDescription: "Implement customer registration, login, email verification, and password reset flows in your Vendure storefront using the Shop API GraphQL mutations."
---
