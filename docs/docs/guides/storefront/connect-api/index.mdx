...
metaTitle: "Connecting Your Storefront to the Vendure Shop API"
metaDescription: "Configure a GraphQL client to connect to Vendure's Shop API with session management, channel tokens, and language settings. Includes Fetch, Apollo, and TanStack examples."
---
