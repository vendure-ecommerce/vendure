...
metaTitle: "Listing and Searching Products in a Vendure Storefront"
metaDescription: "Display collection products, perform full-text search, and implement faceted filtering using Vendure's optimized search query in your storefront."
---
