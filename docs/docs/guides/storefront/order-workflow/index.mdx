...
metaTitle: "Vendure Order Workflow and State Transitions"
metaDescription: "Understand the Vendure Order state machine, order structure, and the full client-side workflow from cart manipulation through checkout and payment."
---
