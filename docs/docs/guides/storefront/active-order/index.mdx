...
metaTitle: "Managing the Active Order (Cart) in Vendure"
metaDescription: "Add, remove, and adjust items in the shopping cart, and apply or remove coupon codes using the Vendure Shop API active order mutations."
---
