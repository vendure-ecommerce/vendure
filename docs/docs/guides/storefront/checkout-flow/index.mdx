---
title: "Checkout Flow"
metaTitle: "Storefront Checkout Flow with the Vendure Shop API"
metaDescription: "Walk through each checkout step in Vendure: setting customer details, shipping address, shipping method, payment, and order confirmation via GraphQL mutations."
---
