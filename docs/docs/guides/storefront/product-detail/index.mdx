...
metaTitle: "Building a Product Detail Page with the Vendure Shop API"
metaDescription: "Fetch product data, display variants and images, format prices, and add items to the cart using the Vendure GraphQL Shop API."
---
