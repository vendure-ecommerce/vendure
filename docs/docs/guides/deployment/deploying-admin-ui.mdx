...
metaTitle: "Deploying the Vendure Admin UI as a Stand-Alone App"
metaDescription: "Compile and deploy the Vendure Admin UI with custom extensions, configure API host and port settings, and optionally host it as a stand-alone static app."
---
