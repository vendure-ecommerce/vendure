...
metaTitle: "Vendure Server Resource Requirements: RAM, CPU, and Load Testing"
metaDescription: "Understand the RAM and CPU requirements for running a Vendure server and worker, and why horizontal scaling is more effective than vertical for Node.js apps."
order: 1
---
