...
metaTitle: "Deploying Vendure to Render with Postgres and Persistent Disk"
metaDescription: "Complete walkthrough for deploying Vendure on Render, including Postgres setup, persistent disk for assets, environment groups, and a background worker."
---
