...
metaTitle: "Deploying Vendure to Google Cloud Run with Cloud SQL and Cloud Tasks"
metaDescription: "Deploy a containerized Vendure application on Google Cloud Run using Cloud SQL for the database, Cloud Storage for assets, and Cloud Tasks for the job queue."
---
