...
metaTitle: "Deploying Vendure to Digital Ocean App Platform"
metaDescription: "Step-by-step guide to deploying a Vendure e-commerce server on Digital Ocean App Platform with Postgres, Spaces object storage, and a separate worker process."
---
