...
metaDescription: "Define promotion conditions and actions in Vendure for order-level, item-level, and shipping discounts. Includes free gift and buy-X-get-Y-free examples."
---
