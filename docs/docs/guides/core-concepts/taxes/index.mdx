---
title: "Taxes"
metaTitle: "Tax Configuration and Calculation in Vendure"
metaDescription: "Configure tax categories, rates, zones, and calculation strategies in Vendure. Covers price-inclusive vs exclusive tax, order line tax, and shipping tax."
---
...
* **Tax rates** This is the tax rate applied to a specific tax category for a specific [Zone](/core-concepts/zones/). E.g., the tax rate for "standard" goods in the UK Zone is 20%.
