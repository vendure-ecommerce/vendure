...
metaDescription: "Configure shipping eligibility checkers, calculators, and fulfillment handlers in Vendure. Includes custom checker, calculator, and state machine examples."
---
