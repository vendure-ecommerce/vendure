...
metaTitle: "Handling Money and Currency in Vendure"
metaDescription: "Vendure stores monetary values as integers in minor units to avoid rounding errors. Covers display formatting, multi-currency support, and the MoneyStrategy."
---
