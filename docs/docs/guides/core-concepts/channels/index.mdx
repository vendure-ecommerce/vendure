---
title: "Channels"
metaTitle: "Channels for Multi-Tenant and Multi-Vendor Setups in Vendure"
metaDescription: "Use Vendure channels to run multiple storefronts, currencies, and sellers from one instance. Covers channel-aware entities, pricing, and marketplace patterns."
---
