...
metaDescription: "Vendure's auth system explained: native and external authentication strategies, roles, permissions, and examples for Google, Facebook, and Keycloak SSO."
---
