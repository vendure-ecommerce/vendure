---
title: "Inventory"
metaTitle: "Inventory and Stock Management in Vendure"
metaDescription: "Vendure inventory management explained: stock locations, allocation strategies, back orders, stock movements, and how saleable quantities are calculated."
---
...
Stock movements can be queried via the `ProductVariant.stockMovements` field in the Admin API.

## Code Examples

### InsufficientStockError

If there is 0 saleable stock, any attempt to add to the order will result in an `InsufficientStockError`:
