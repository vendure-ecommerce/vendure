---
title: "Customers"
metaTitle: "Managing Customers and Customer Groups in Vendure"
metaDescription: "How Vendure models customers, addresses, guest checkouts, and customer groups for promotions, shipping rules, and B2B segmentation."
---
...
:::info
See the [User Management](/core-concepts/user-management/) guide for a detailed explanation of the relationship between
customers and users.
:::
