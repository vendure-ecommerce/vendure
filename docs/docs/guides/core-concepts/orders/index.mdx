...
metaDescription: "Vendure's order process from cart to delivery, powered by a finite state machine. Covers default states, custom order processes, interceptors, and transitions."
---
