...
metaDescription: "Collections group product variants for navigation, promotions, and storefront display. Covers built-in filters, filter inheritance, and custom filter creation."
---
