---
title: "Logging"
metaTitle: "Logging Configuration in Vendure - Levels, Custom Loggers, and DB Queries"
metaDescription: "Configure logging in Vendure with the DefaultLogger or a custom implementation. Covers log levels, database query logging, and production best practices."
---
