...
metaTitle: "Adding REST Endpoints to a Vendure Plugin"
metaDescription: "Define REST-style HTTP endpoints in Vendure plugins using NestJS controllers, with access to Vendure services and the RequestContext."
---
