...
metaTitle: "Vendure v1 to v2 Database Migration Guide"
metaDescription: "Run the automated database migration from Vendure v1 to v2 using the MigrationV2Plugin, with step-by-step instructions for PostgreSQL and MySQL."
order: 2
---
