...
metaTitle: "Migrating from Vendure v1 to v2 - Complete Guide"
metaDescription: "Step-by-step instructions for upgrading from Vendure v1 to v2, covering dependency updates, database migration, API changes, and storefront adjustments."
order: 1
---
