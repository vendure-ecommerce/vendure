...
metaTitle: "Vendure v1 to v2 Breaking API Changes"
metaDescription: "Detailed list of breaking API changes in Vendure v2, including TypeScript, TypeORM, Apollo Server, and GraphQL updates that affect custom code and plugins."
order: 3
---
