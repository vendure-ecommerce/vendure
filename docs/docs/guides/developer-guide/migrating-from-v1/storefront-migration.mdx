...
metaTitle: "Vendure v2 Storefront Migration - Shop API Breaking Changes"
metaDescription: "Handle the Shop GraphQL API changes in Vendure v2, including updated shipping mutations, fulfillment lines, and the new Money scalar type."
order: 4
---
