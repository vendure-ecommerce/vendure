---
title: "Configuration"
metaTitle: "Vendure Server Configuration - VendureConfig Reference"
metaDescription: "Configure your Vendure server with VendureConfig, including API options, authentication, database connections, plugins, and asset storage settings."
order: 3
---
