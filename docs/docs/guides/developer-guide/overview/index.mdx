...
metaTitle: "Vendure Architecture Overview - Server, Worker, Dashboard, and Storefront"
metaDescription: "A high-level overview of Vendure's headless e-commerce architecture, technology stack, design principles, and core concepts for new developers."
order: 2
---
