...
metaTitle: "Defining Custom Permissions for Vendure Plugins"
metaDescription: "Create fine-grained custom permissions in Vendure plugins using PermissionDefinition to control access to new mutations, queries, and features."
---
