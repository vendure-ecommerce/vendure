...
metaTitle: "Updating Vendure - Versioning Policy and Upgrade Steps"
metaDescription: "Safely update your Vendure installation to newer versions. Covers the versioning policy, breaking change expectations, and the recommended upgrade workflow."
---
