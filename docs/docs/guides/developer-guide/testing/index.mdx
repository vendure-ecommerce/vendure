---
title: "Testing"
metaTitle: "Writing E2E Tests for Vendure Plugins"
metaDescription: "Set up end-to-end testing for Vendure plugins using the @vendure/testing package and Vitest, with real API requests against a test server and database."
---
