...
metaTitle: "Bulk Data Import in Vendure - CSV Product Import Format"
metaDescription: "Import products, variants, assets, and facets into Vendure using the CSV import format. Includes column reference, custom fields, and the InitialData API."
---
