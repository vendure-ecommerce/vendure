...
metaTitle: "Strategies and Configurable Operations in Vendure"
metaDescription: "Understand how Vendure uses the strategy pattern and configurable operations to provide extensible, pluggable behavior for orders, taxes, shipping, and more."
order: 4
---
