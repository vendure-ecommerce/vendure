...
metaTitle: "Vendure Service Layer - Business Logic and Database Access"
metaDescription: "Understand Vendure's service layer where business logic lives. Covers service structure, dependency injection, the RequestContext, and TransactionalConnection."
order: 2
---
