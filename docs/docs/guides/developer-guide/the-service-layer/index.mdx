...
can be imported from the `@bb-vendure/core` package.
...
import { Injectable } from '@nestjs/common';
import { ProductService } from '@bb-vendure/core';
...
import { Injectable } from '@nestjs/common';
import { ID, RequestContext, TransactionalConnection } from '@bb-vendure/core';
import { IsNull } from 'typeorm';
...
```ts
import { EntityHydrator, ShippingCalculator } from '@bb-vendure/core';
