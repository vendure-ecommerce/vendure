---
title: "Nest Devtools"
metaTitle: "Using NestJS Devtools with Vendure for Debugging"
metaDescription: "Set up NestJS Devtools in your Vendure project to inspect, analyze, and debug your application with the official NestJS developer tools."
---
