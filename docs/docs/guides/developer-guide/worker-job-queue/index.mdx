...
import { bootstrapWorker, mergeConfig } from '@bb-vendure/core';
import { config } from './vendure-config';
...
(which will be used in a standard `@bb-vendure/create` installation), which configures Vendure to use the [SqlJobQueueStrategy](/reference/typescript-api/job-queue/sql-job-queue-strategy).
...
import { Allow, Ctx, RequestContext, Permission, RequestContext } from '@bb-vendure/core'
...
import { JobQueue, JobQueueService, ID, Product, TransactionalConnection } from '@bb-vendure/core';
...
import { JobQueue, JobQueueService, Product, TransactionalConnection,
    SerializedRequestContext, RequestContext } from '@bb-vendure/core';
...
import { Injectable, OnModuleInit } from '@nestjs/common';
import { JobQueue, JobQueueService, Product, TransactionalConnection,
    SerializedRequestContext, RequestContext, Job, JobState } from '@bb-vendure/core';
...
import { ID, Product, TransactionalConnection } from '@bb-vendure/core';
