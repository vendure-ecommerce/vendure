...
metaTitle: "File Uploads in Vendure - GraphQL Multipart Requests"
metaDescription: "Upload files to Vendure as assets using the GraphQL multipart request spec. Covers client setup, the createAssets mutation, and custom upload endpoints."
---
