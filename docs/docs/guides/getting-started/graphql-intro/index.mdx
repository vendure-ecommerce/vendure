...
metaTitle: "GraphQL Basics for Vendure Developers"
metaDescription: "A developer-friendly introduction to GraphQL concepts used in Vendure: queries, mutations, types, fragments, variables, union types, and IDE tooling."
---
