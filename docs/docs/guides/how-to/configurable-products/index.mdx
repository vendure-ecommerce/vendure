...
metaTitle: "Configurable Products in Vendure with Custom Fields"
metaDescription: "Use OrderLine custom fields to support customer-configurable products like engravings or gift messages, with optional dynamic pricing via a custom strategy."
---
