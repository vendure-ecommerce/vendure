...
metaTitle: "Publishing a Vendure Plugin to npm and Vendure Hub"
metaDescription: "Package, document, and publish your Vendure plugin to npm, and meet the requirements for listing on Vendure Hub including changelog, docs, and tests."
---
