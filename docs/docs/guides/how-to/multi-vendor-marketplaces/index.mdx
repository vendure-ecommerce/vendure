...
metaTitle: "Building Multi-Vendor Marketplaces with Vendure"
metaDescription: "Architect a multi-vendor marketplace using Vendure Channels, Sellers, order splitting, and custom shipping and payment strategies."
---
