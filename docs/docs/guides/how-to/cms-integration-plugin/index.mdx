...
This is done in a way that establishes Vendure as the source of truth for the entities' data.
...
:::tip Working Example
The complete, production-ready Storyblok implementation can be found in the [Storyblok integration example](https://github.com/vendure-ecommerce/examples/tree/publish/examples/storyblok-cms-integration). Refer to it for a minimal working implementation.
:::
