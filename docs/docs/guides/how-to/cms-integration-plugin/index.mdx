...
:::tip Working Example
The complete source code for this Storyblok integration can be found in the [cms-integration-plugin example repository](https://github.com/vendure-ecommerce/examples/tree/master/examples/cms-integration-plugin).
:::
