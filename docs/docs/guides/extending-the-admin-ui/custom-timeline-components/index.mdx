...
metaTitle: "Custom History Timeline Components for the Vendure Admin UI"
metaDescription: "Render custom history entry types in the Order and Customer timelines by registering Angular components with registerHistoryEntryComponent."
---
