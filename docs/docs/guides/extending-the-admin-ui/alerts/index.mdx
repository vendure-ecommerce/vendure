---
title: 'Alerts'
metaTitle: "Custom Admin UI Alerts in Vendure"
metaDescription: "Register custom alerts in the Vendure Admin UI top bar to notify administrators about conditions requiring attention, with periodic data checks and actions."
---
