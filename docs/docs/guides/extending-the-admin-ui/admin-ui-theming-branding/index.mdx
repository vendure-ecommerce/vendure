...
metaTitle: "Theming and Branding the Vendure Admin UI"
metaDescription: "Customize the Vendure Admin UI with your brand name, logos, favicon, and CSS theme variables using the AdminUiPlugin and ui-devkit."
---
