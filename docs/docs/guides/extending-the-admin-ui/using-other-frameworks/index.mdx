...
metaTitle: "Using Vue, Svelte, or Other Frameworks in Vendure Admin UI"
metaDescription: "Extend the Vendure Admin UI with Vue, Svelte, or other frameworks using hostExternalFrame, static assets, the UiDevkitClient, and theme integration."
order: 1
---
