...
metaTitle: "Adding UI Translations to the Vendure Admin UI"
metaDescription: "Add new languages, create custom translations for UI extensions, and override existing translations in the Vendure Admin UI using Messageformat."
---
