...
metaTitle: "Modifying the Vendure Admin UI Navigation Menu"
metaDescription: "Add new sections and menu items to the Admin UI sidebar navigation, override existing nav items, or remove built-in entries using addNavMenuSection."
order: 5
---
