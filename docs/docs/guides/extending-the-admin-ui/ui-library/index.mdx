...
metaTitle: "Vendure Admin UI Component Library Reference"
metaDescription: "A guide to the built-in UI components available for Admin UI extensions: buttons, icons, form inputs, cards, and layout components for Angular and React."
---
