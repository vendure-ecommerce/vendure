...
metaTitle: "Getting Started with Vendure Admin UI Extensions"
metaDescription: "Set up the ui-devkit package to create Admin UI extensions with providers and routes, configure compileUiExtensions, and run in dev or production mode."
---
