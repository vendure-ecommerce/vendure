...
metaTitle: "Adding ActionBar Buttons to Vendure Admin UI Pages"
metaDescription: "Add custom buttons and dropdown menu items to the Admin UI ActionBar using addActionBarItem, with click handlers, visibility control, and permissions."
order: 5
---
