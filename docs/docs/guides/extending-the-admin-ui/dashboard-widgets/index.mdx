...
metaTitle: "Creating Dashboard Widgets for the Vendure Admin UI"
metaDescription: "Build custom Angular dashboard widgets to display summaries, notifications, or charts, and configure default widget layouts and permission controls."
---
