...
metaTitle: "Custom Bulk Actions for Vendure Admin UI List Views"
metaDescription: "Define custom bulk actions on Admin UI list views using registerBulkAction, with support for modal dialogs and conditional visibility based on context."
---
