...
metaTitle: "Custom Detail Components for the Vendure Admin UI"
metaDescription: "Embed custom Angular or React components into Admin UI detail pages to display additional data and interact with the detail form."
---
