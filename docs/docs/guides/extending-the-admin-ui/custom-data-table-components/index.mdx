...
metaTitle: "Custom DataTable Column Components for the Vendure Admin UI"
metaDescription: "Register custom Angular or React components to render specific data table columns in Admin UI list views with registerDataTableComponent."
order: 6
---
